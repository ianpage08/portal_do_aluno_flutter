...
class ContratoPdfService {
          ...
          pw.Padding(
            ...
            child: pw.Column(
              ...
              tituloClausula('CLÁUSULA 1: OBJETO'),
                ...
                tituloClausula('CLÁUSULA 2: OBRIGAÇÕES DO RESPONSÁVEL'),
                clausula(
                ...
                tituloClausula('CLÁUSULA 3: OBRIGAÇÕES DA INSTITUIÇÃO'),
                clausula(
                ...
                tituloClausula('CLÁUSULA 4: RESCISÃO'),
                clausula(
                ...
                tituloClausula('CLÁUSULA 5: DADOS MÉDICOS E AUTORIZAÇÕES'),
                clausula(
                ...
                tituloClausula('CLÁUSULA 6: DISPOSIÇÕES FINAIS'),
                clausula(
  ...
  pw.Widget tituloClausula(String titulo) {
    return pw.Padding(
  ...
  pw.Widget clausula(String texto, {required pw.TextStyle estilo}) {
