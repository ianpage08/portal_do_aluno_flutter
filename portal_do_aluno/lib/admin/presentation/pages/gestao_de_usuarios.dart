...
class _GestaoDeUsuariosState extends State<GestaoDeUsuarios> {
  ...
  void _adicionarUsuario() {
    if (_formKey.currentState!.validate()) {
      ...
      final perfil = perfilController.text.trim();

      if (nome.isNotEmpty && perfil.isNotEmpty) {
        final novousuario = Usuario(nome, perfil);
        setState(() {
